  ...
  const openPopupboxBand01 = () => {
    const content = (
      <>
        ...
        <b>Bands Of America:</b>{' '}
        <a
          className="hyper-link"
          onClick={() => window.open('https://marching.musicforall.org/')}
        >
          https://marching.musicforall.org/{' '}
        </a>
      </>
    )
    ...
    const content = (
      <>
        <img
          className="portfolio-image-popupbox"
          src={band02}
          alt="Color Guard Collage"
        />
        <p>Ea consectetur amet minim commodo cillum laboris qui.</p>
        <b>WGI:</b>{' '}
        <a
          className="hyper-link"
          onClick={() => window.open('https://wgi.org/')}
        >
          https://wgi.org/
        </a>
      </>
  ...
  const openPopupboxBand03 = () => {
    const content = (
      <>
        ...
        <a
          className="hyper-link"
          onClick={() => window.open('https://sfwga.org/Home.htm')}
        >
          https://sfwga.org/Home.htm
        </a>
      </>
    )
    PopupboxManager.open({ content })
        ...
        <div className="image-box-wrapper">
          ...
          <div className="portfolio-image-box" onClick={openPopupboxBand04}>
            <img
              className="portfolio-image"
              src={band04}
              alt="Color Guard at starting gate"
            />
            <div className="overflow"></div>
            <FontAwesomeIcon className="portfolio-icon" icon={faSearchPlus} />
          </div>
